...
class GenNumber extends React.Component {
  componentDidUpdate() {
    let time, digit; // increase showing time depend on level
  ...
  render() {
    ...
    }, "Level: ", this.props.level.main, " - ", this.props.level.sub), /*#__PURE__*/React.createElement("p", {
      className: "app__wrong"
    }, "Wrong: ", this.props.wrong, "/3")), /*#__PURE__*/React.createElement("p", {
      className: "app__divider"
    }, "############################"), /*#__PURE__*/React.createElement("p", {
      className: "app__number",
      id: "number"
    }, this.props.wrong < 3 ? atob(this.props.question) : "????"), /*#__PURE__*/React.createElement("p", {
      className: "app__divider"
    }, "############################"));
  }
...
class InputNumber extends React.Component {
  ...
  render() {
    ...
    if (this.props.wrong < 3) {
      ...
      }, "Number is:", /*#__PURE__*/React.createElement("input", {
        pattern: "[0-9]+",
        type: "text",
      ...
      layout = /*#__PURE__*/React.createElement("div", {
        ...
        class: "app__notify"
      }, "Better luck next time (\u2727\u03C9\u2727)"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("button", {
        onClick: this.handleReset
      }, "Restart"));
    }
...
class App extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      className: "main__app"
    }, /*#__PURE__*/React.createElement(GenNumber, {
